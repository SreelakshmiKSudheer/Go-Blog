...
const AddBlog = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-center mb-6 text-[#463120]">Add a Blog</h2>
      <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
        ...
        <button
          type="submit"
          className="bg-[#463120] hover:bg-[#5d4532] text-white font-semibold py-2 rounded-md transition-colors duration-300"
        >
          Add Blog
        </button>
      </form>
